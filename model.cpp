...
void Model::initializeModelFromObjectFile(char *objectFile, char * textureFile, float amb[4], float diff[4], float spec[4], float shine, mat4 transf)
{
...
void Model::initializeModelFromFloatArray(GLfloat array[100000 * 12][3], int numberOfTriangles,char * textureFile, float amb[4], float diff[4], float spec[4], float shine, mat4 transf)
{
	batch.Begin(GL_TRIANGLES, numberOfTriangles * 100000);
    batch.CopyVertexData3f(array);
    batch.End();
